...
export default function ProductCard({
  ...
  const handleWhatsAppInquiry = () => {
    const phoneNumber = '919368555196';
    const message = `Hi! I would like to check availability for ${name}. Can you help me with details?`;
  ...
  const handleEmailInquiry = () => {
    window.location.href = 'tel:+919368555196';
    setShowModal(false);
  };
  ...
  return (
    <>
      <motion.div
        ...
        className="bg-white rounded-lg overflow-hidden border border-gray-200 hover:border-emerald-500 transition group shadow-md hover:shadow-lg cursor-pointer"
      >
        {/* Image Container */}
        ...
        {/* Content */}
        <div className="p-6">
          <p className="text-emerald-700 text-sm uppercase tracking-widest mb-2 font-semibold">
            {category}
          </p>
          ...
          <div className="flex items-center justify-center">
            <motion.button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-lg font-semibold transition shadow-md w-full"
            >
              Enquire Now
            </motion.button>
          </div>
        ...
        >
          ...
          >
            <div className="text-center mb-6">
              ...
              <p className="text-emerald-700 font-semibold text-sm uppercase">{category}</p>
            </div>
